...
This document defines the `v1` publication gate. Hosted Services owns
...
- probe targets follow `docs/operations/hosted-service-probe-model.md` and never resolve
