...
Reported source commit: `21460bcc4602164e588043c74f0eacf1f4ca001f`.
...
| `deployment.multi-host` | operations-release | partial | partial | no | no | R3 |
...
- Status at `21460bcc4602164e588043c74f0eacf1f4ca001f`: I=yes, R=yes, O=yes, Q=no
- Research class: R3
...
- Status at `21460bcc4602164e588043c74f0eacf1f4ca001f`: I=no, R=no, O=no, Q=no
- Research class: R2
...
- Domain: `operations-release`; owner: Operations and Release
- Supported interfaces: `topology-operator-v1` (operator): `internal/cli/topology`, `internal/deployment`, `docs/operations/multi-host-topology-contract.md`, `docs/operations/multi-host-status-contract.md`; `deployment-scripts` (artifact): `scripts/deploy/cluster.ps1`, `deploy/docker/compose/docker-compose.multinode.yml`
- Implementation owners: `internal/deployment`, `internal/deploymentjournal`, `internal/cli/topology`, `scripts/deploy`, `deploy/docker`
- Operability: pin-validated topology status and authority recovery; cluster deployment and multinode status
- Evidence owner: Operations and Network / QA
- Required evidence gates: `static`, `deployment`, `multinode`, `security`, `release-candidate`
- Status at `21460bcc4602164e588043c74f0eacf1f4ca001f`: I=partial, R=partial, O=no, Q=no
- Research class: R3
...
- Backlog: `.scratch/post-wave3-program/issues/26-multi-host-mr08.md`
- Constraints: Accepted MR-01 through MR-07 provide strict exact-three-host admission, pin-validated read-only SSH status/recovery, deterministic placement/reachability/fence/rejoin/rollout coordinators, strict protected journals and local-substitutable failure injection; production mutating adapter composition and the complete matching-commit private-LAN/public-direct R3 environment remain required by MR-08
- Unsupported: No supported real multi-host deployment or qualification claim; consumer-owned mutation seams are not production-composed; arbitrary node counts, automatic NAT traversal, schedulers, Kubernetes, remote Operator/Application APIs, and partial/local substitution for MR-08 remain unsupported
...
- Status at `21460bcc4602164e588043c74f0eacf1f4ca001f`: I=yes, R=partial, O=yes, Q=no
- Research class: R2
...
- Status at `21460bcc4602164e588043c74f0eacf1f4ca001f`: I=yes, R=yes, O=partial, Q=no
- Research class: R3
...
- Required evidence gates: `static`, `security`, `deployment`, `release-candidate`
- Status at `21460bcc4602164e588043c74f0eacf1f4ca001f`: I=partial, R=no, O=no, Q=no
- Research class: R2
