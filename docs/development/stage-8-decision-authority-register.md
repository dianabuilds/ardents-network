...
| DA-02 | What is the single Network State missing-current recovery rule? | F014 contradicts the accepted R-027/R-029 recovery interpretation; D01/W01 repairs have no safe meaning until reconciled. | Reconciliation of R-027/R-029 with a failure/restart transition table; Product Owner acceptance; ADR only if persistence/protocol policy changes. | Do not alter missing-pointer repair, pointer format, or recovery oracle. |
