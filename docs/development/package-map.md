...
| `internal/qualification/recoverysmoke` | `package recoverysmoke` | Prepare, run, observe, independently verify, externally fault, and clean up the bounded local Docker Stage 4 S4.1/S4.2 campaign while retaining public-only evidence. | `internal/qualification/byteio`, `internal/qualification/recovery`, `internal/qualification/routesmoke`, `internal/qualification/servicenegative`, `internal/route`, `internal/serviceconn`, `golang.org/x/sys/unix`, standard library |
