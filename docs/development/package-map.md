...
| `cmd/ardents-name` | `package main` | Validate canonical S6.1 Service Name and Name Record encodings without performing a naming control operation, resolution, or cryptographic selection. | `internal/naming`, `internal/namelease`, standard library |
