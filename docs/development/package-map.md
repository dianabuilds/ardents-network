...
| `internal/qualification/recoverysmoke` | `package recoverysmoke` | Prepare, run, observe, independently verify, and clean up the bounded local Docker Stage 4 recovery campaign while retaining public-only evidence. | `internal/qualification/byteio`, `internal/qualification/recovery`, `internal/qualification/routesmoke`, `internal/qualification/servicenegative`, `internal/route`, `internal/serviceconn`, standard library |
