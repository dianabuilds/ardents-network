...
| `cmd/ardents-service-qualify` | `package main` | Read one bounded Stage 3 evidence value, call the independent Service Connection verifier, and render its terminal machine result. | `internal/qualification/service`, standard library |
