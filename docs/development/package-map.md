...
| `cmd/ardents-service` | `package main` | Parse one role-local Stage 3 Endpoint plan, bind scoped Unix sockets, call the Service Connection Module, and render its bounded result. | `internal/applicationipc`, `internal/serviceconn`, standard library |
