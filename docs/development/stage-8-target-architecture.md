...
| `internal/namestore` | Transfer the remaining durable materialization responsibility behind `naming/namespace`; remove duplicate validators, field bags, and stage fixtures. | M5, subject to DA-03/04/05/07. |
