...
| `internal/nameauthority`, `internal/nameclaim`, `internal/namelease`, `internal/namerecovery`, `internal/namestore` | Transfer their remaining Namespace responsibilities behind `naming/namespace`; remove duplicate validators, field bags, and stage fixtures. | M5, subject to DA-03/04/05/07. |
