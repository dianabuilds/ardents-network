...
| `internal/service/connection` | Retain the M9 target owner for closed ADR-0028 endpoint records and their immutable context. The temporary `serviceconn` adapter supplies retained stream state until its full cutover; no H3 record reader may be added. | M9 under R-083/ADR-0028. |
