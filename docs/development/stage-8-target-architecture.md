...
| `cmd/blocked-entry-verify-lab`, `cmd/carrier-lab`, `cmd/named-site-lab` | Historical reproduction with a named retained obligation, or delete the runner while retaining immutable provenance. | M14, subject to DA-11; R-080 already retires the Stage-5 evidence generator. |
