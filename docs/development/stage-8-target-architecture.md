...
| `cmd/ardents-release` | Retire as an H3 product command. R-088/ADR-0030 allow it only until the C0 V2 Update-fixture cutover and C4 V0 verifier are complete; no C2 operator observer remains. | M1/M2/M13, subject to DA-01/R-064/R-088 and DA-10. |
