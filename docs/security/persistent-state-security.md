...
| Realm Authority successor signer | optional configured external `authority.successor_signer_file` | secret | independently preprovisioned protected signer used only by the dual-signed transition and checkpoint roll-forward continuity seam; never copied into ledger or repository |
