...
| Capability delivery X25519 key | encrypted Identity capability ledger in `ardents.db` | secret | generated by standard `crypto/hpke`, encrypted under the externally provisioned channel-grant-store key, and distinct from the Ed25519 signing key |
