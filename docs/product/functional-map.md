...
| NET-04A | An existing external Application can use a local socket/proxy-style Application Interface without embedding a mandatory Ardents SDK or networking library. | fixed | R-002 P1-D1; concrete local protocol and operating-system binding remain open. |
