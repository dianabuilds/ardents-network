...
| NET-13 | Every privacy, availability, and decentralization claim is shown as a Route Profile or another testable contract with an honest limitation. | fixed | R-001 P2-D1 establishes the first explicit limit; the remaining R-001 decisions and threat model complete the claim matrix. |
