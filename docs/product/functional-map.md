...
| NET-13 | Every privacy, availability, and decentralization claim is shown as a Route Profile or another testable contract with an honest limitation. | fixed | R-001 P2-D1 through P2-D5 establish the observer, Node, collusion, and malicious-endpoint boundaries; the remaining R-001 decisions and threat model complete the claim matrix. |
