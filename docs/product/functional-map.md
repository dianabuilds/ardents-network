...
| NET-13 | Every privacy, availability, and decentralization claim is shown as a Route Profile or another testable contract with an honest limitation. | fixed | R-001 P2-D1 through P2-D6 establish observer, Node, collusion, endpoint, and active-attack boundaries; P2-D7 and the threat model complete the claim matrix. |
