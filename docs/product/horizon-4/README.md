...
| H4-5 / H4-7 | H4-5 has selected the existing H4-2 Rendezvous duty for one dedicated Ubuntu functional-alpha profile; implementation and fresh-host qualification remain open. H4-7 retains only its research boundary. | H4-5 makes no capacity, availability, co-resident, public-admission, or independent-operation claim; H4-7 remains unnecessary for the ordinary browser path. |
