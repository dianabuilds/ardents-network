...
| H4-8 | The exact immutable candidate now has green A1-A10 functional-alpha cells, including publication, enrollment, H4-6A control, browser observation, and TCP/TLS no-fallback. | A11 soak/fault acceptance and A12 closure inventory remain before broader H4-8 closure; Public Beta retains all independent external gates. |
