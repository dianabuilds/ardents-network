...
It does not replace `docs/protocols/canonical-network-foundation.md` or
`docs/protocols/network-and-discovery-requirements.md`. It defines how product semantics
...
defined in `docs/protocols/network-privacy-protocol.md`.
