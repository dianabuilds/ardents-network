...
| [R-003](records/r-003-service-name-contract.md) | How does an exact Service Name bind to a Service Target, resolve without becoming a directory, survive accepted rotation, and handle registration, expiry, recovery, conflict, enumeration, query privacy, and Control Plane capture? | **Active:** P4-D1 fixes a distinct Name Authority independently of Service Authority. P4-D2a fixes one canonical network-wide Namespace. P4-D2b fixes permissionless Name Leases and explicit conflicts. P4-D2c fixes ASCII hierarchy, explicit Service Link, and no DNS behavior. P4-D3 fixes Active, Grace, Released, Name Generation, monotonic records, and parent-bounded descendants. P4-D4 fixes authenticated successor rotation or transfer plus optional precommitted delayed threshold Recovery Policy and fail-closed Recovery Pending. Numeric parameters, resolution privacy, governance, and the anti-abuse mechanism remain open; no registry or cryptographic recovery technology is selected. | active |
