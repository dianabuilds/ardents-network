...
|---|---|---|
| R-157 / [#78](https://github.com/dianabuilds/ardents-network/issues/78) | What receive-credit and shared DATA/control reservation makes every admitted Source/forwarding lane promise payable under the existing prefix, nested-parent and receiving-duty ceilings without silently reducing the selected workload? | **Prepared; awaiting Product Owner capacity choice.** [Draft PR #256](https://github.com/dianabuilds/ardents-network/pull/256) found the existing 64 KiB-per-lane initial credit is not fully backed by the shared queue at maximum admitted fan-out. No #79 runtime change or capacity maximum is selected by this row. |
| [R-160](records/r-160-hosting-remaining-exposure.md) / [#84](https://github.com/dianabuilds/ardents-network/issues/84) | What remaining-exposure formula counts spent bytes, still-payable admitted work and a real termination reserve exactly once across initial admission, refill and close? | **Prepared; awaiting Product Owner accounting direction and exact work/termination bounds.** [Draft PR #261](https://github.com/dianabuilds/ardents-network/pull/261) derives conservative gross exposure, initial→refill→close/concurrent-refill oracles, and identifies missing per-refill work and terminal upper envelopes. [#262](https://github.com/dianabuilds/ardents-network/issues/262) owns retained Carrier-pool future cost separately. No #85 runtime or storage/tariff change is selected. |
