...
| [R-049](records/r-049-stage-7-release-verifier.md) | Which maintained TUF-compatible Go verifier and exact bounded H3 metadata profile meet ADR-0006 without first-party update cryptography or a distributor authority? | **Open:** measure conformance, dependency/license/advisory closure, cache/path confinement, role/threshold/expiry/rollback/freeze/mix behavior, and one-to-one maintenance before selecting a dependency/profile. | open |
