...
| [R-023](records/r-023-interactive-route-performance-budget.md) | What end-to-end performance budget makes the V1 Interactive Route and Named Unlisted Site useful without weakening the accepted security contract? | **Active:** P3-D1 through P3-D5 fix platforms, useful performance, finite resources, recovery, admission, and hostile-work isolation. P3-D6a makes qualification conjunctive across every mandatory cell with hard security guardrails. P3-D6b1 fixes four endpoint-role OS pairings—Windows/Windows, Windows/Linux, Linux/Windows, and Linux/Linux—in both data directions on separate machines or isolated VMs through controlled links. Production protections and Route shape remain active; paired direct baselines bracket each applicable Ardents batch, while uncontrolled Internet evidence is supplementary. P3-D6b2/c still define exact inputs, sampling, artifacts, and regression rules, while role-specific Node capacity and cost follow R-004 evidence. | active |
