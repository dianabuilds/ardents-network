...
5. **Closed test network — Stage 1 implementation active:** accepted R-029 joins
   authenticated state and a real Node lifecycle. R-027 and R-028 supply only
   its bootstrap and resource/evidence appendices; their standalone H3-A work
   order is withdrawn. Route, recovery/capacity, Bridges, naming, updates,
   Windows, and broader Application boundaries remain later decision gates.
