...
| 10 | Public-control, permissionless admission, and Public Beta | Later questions only when real independent participants/evidence exist | H4-4C, H4-5D, H4-6C/D, and promotion review | the existence or independence of people not yet present |
