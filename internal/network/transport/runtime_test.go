...
func TestRuntimeLoopDoesNotSpinOnClosedReachabilitySubscription(t *testing.T) {
	...
	service := New(Config{ReachabilityMode: networkreadiness.ReachabilityPublicDirect})
	service.reachabilityEvents = subscription
	service.reachability = networkreadiness.ReachabilitySnapshot{
		Mode: networkreadiness.ReachabilityPublicDirect, State: "public", Reachable: true,
	}
