...
func decodePrivateMessage(inner []byte) (*wire.PrivateMessageV1, error) {
...
func authorizePrivateMessage(request OpenRequest, header envelopeHeader, message *wire.PrivateMessageV1) (OpenedMessage, error) {
	class := MessageClass(message.MessageClass)
