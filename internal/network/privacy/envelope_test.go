...
func TestPrivateEnvelopeRejectsInvalidInnerSignatureAndSenderGrant(t *testing.T) {
	...
	badSignature := rewriteAuthenticatedInner(t, fixture, sealed, func(message *wire.PrivateMessageV1) {
		message.Signature[0] ^= 1
	})
	requireEnvelopeCode(t, openWithFreshReplay(t, fixture, badSignature), CodeEnvelopeSignatureInvalid)

	badPadding := rewriteAuthenticatedInner(t, fixture, sealed, func(message *wire.PrivateMessageV1) {
		message.Padding[0] = 1
	})
	requireEnvelopeCode(t, openWithFreshReplay(t, fixture, badPadding), CodeEnvelopeMalformed)

	badProtocol := rewriteAuthenticatedInner(t, fixture, sealed, func(message *wire.PrivateMessageV1) {
		message.ProtocolVersion = 2
	})
	requireEnvelopeCode(t, openWithFreshReplay(t, fixture, badProtocol), CodeEnvelopeMalformed)

	badClass := rewriteAuthenticatedInner(t, fixture, sealed, func(message *wire.PrivateMessageV1) {
		message.MessageClass = 99
	})
	requireEnvelopeCode(t, openWithFreshReplay(t, fixture, badClass), CodeEnvelopeSenderUnauthorized)

	badPrincipal := rewriteAuthenticatedInner(t, fixture, sealed, func(message *wire.PrivateMessageV1) {
...
func rewriteAuthenticatedInner(t *testing.T, fixture envelopeFixture, sealed SealedEnvelope, mutate func(*wire.PrivateMessageV1)) SealedEnvelope {
	t.Helper()
