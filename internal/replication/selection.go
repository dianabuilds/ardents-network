...
func (s *Service) observeCandidates(ctx context.Context, blob model.Blob, excluded map[string]bool) []placement.Candidate {
...
func (s *Service) observeCandidate(ctx context.Context, target string, blob model.Blob) placement.Candidate {
...
func (s *Service) queryCapacityWithRetry(ctx context.Context, target string, blob model.Blob) (capacityObservation, error) {
...
func (s *Service) queryCapacity(ctx context.Context, target string, blob model.Blob) (capacityObservation, error) {
