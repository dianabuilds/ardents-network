...
func planRollbackRefused(facts inventoryResult, transaction uint64, custodyNotice string) (recoveryPlan, error) {
	...
	return recoveryPlan{Row: "R23", Outcome: "rollback-refused", State: "repair-required", Generation: transaction,
		...
		SafeNotice: "update rollback refused", CustodyNotice: custodyNotice}, nil
}
