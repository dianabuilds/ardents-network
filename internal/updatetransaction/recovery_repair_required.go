...
func planRepairRequired(facts inventoryResult, transaction uint64, custodyNotice string) (recoveryPlan, error) {
	...
	return recoveryPlan{Row: "R24", Outcome: "repair-required", State: "repair-required", Generation: transaction,
		...
		SafeNotice: "update repair required", CustodyNotice: custodyNotice}, nil
}
