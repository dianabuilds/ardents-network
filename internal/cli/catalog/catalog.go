...
var commands = []CommandSpec{
	...
	protected("authority.membership.fence", []string{"authority", "membership", "fence"}, "--realm-id ID --channel-id HEX --operation-id ID --evidence-file FILE", "submit bounded deployment fencing evidence", ardentsv1connect.AuthorityServiceSubmitDeploymentFenceEvidenceProcedure, "topology.node.fence", "node", true, OutputProtoJSON, ownerAuthorityMembership),
