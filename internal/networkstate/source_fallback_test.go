...
func TestIncompleteLatestUsesExactSameIndexFallback(t *testing.T) {
	...
	config.SourceServerNames = [2]string{"truncated-source.test", "complete-source.test"}
	config.SourceIdentities = [2][32]byte{{1}, {2}}
	config.SourceFamilies = [2]string{"truncated-family", "complete-family"}
	config.SourceEndpointHandles = [2]string{"truncated-handle", "complete-handle"}
	...
	config.SourceMaterializationIndex = 1
