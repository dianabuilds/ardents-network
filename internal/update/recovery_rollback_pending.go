...
func planRollbackPending(facts inventoryResult, transaction uint64, evidenceNotice string) (recoveryPlan, error) {
	...
	return recoveryPlan{Row: "R18", Outcome: "recovered", State: "rollback-pending", Generation: transaction,
		...
		SafeNotice: "update interrupted", EvidenceNotice: evidenceNotice}, nil
}
