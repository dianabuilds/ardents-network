...
func newRecordSet(store *namespace.Store, network [32]byte, minimumEpoch uint64) (recordSet, error) {
...
func validMaterializationPolicy(value namespace.MaterializationPolicy, network [32]byte) bool {
...
func cloneMaterializationPolicy(value namespace.MaterializationPolicy) namespace.MaterializationPolicy {
	copyValue := namespace.MaterializationPolicy{Network: value.Network, Rule: value.Rule,
