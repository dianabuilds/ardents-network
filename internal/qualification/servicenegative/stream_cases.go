...
func (value fixture) connected(ctx context.Context) (*serviceconn.Endpoint, *serviceconn.Endpoint, []byte, bool) {
...
func (value fixture) runConnections(ctx context.Context, client, publisher *serviceconn.Endpoint, publication []byte,
	...
	go func() {
		result, err := client.Do(ctx, serviceconn.Request{Action: "connect", Principal: value.connection,
			...
			Application: clientApplication, BytesEachDirection: 64 << 10, At: value.now})
	...
	go func() {
		result, err := publisher.Do(ctx, serviceconn.Request{Action: "accept", Principal: value.connection,
			...
			BytesEachDirection: 64 << 10, At: value.now})
		outcomes <- streamOutcome{result, err}
	}()
	return outcomes
}
