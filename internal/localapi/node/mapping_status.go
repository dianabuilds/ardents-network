...
func toCapabilitiesSnapshot(in daemonruntime.CapabilitiesSnapshot) *ardentsv1.CapabilitiesSnapshot {
...
func toTransportSnapshot(in *network.Snapshot) *ardentsv1.TransportSnapshot {
	if in == nil {
		return nil
	}
