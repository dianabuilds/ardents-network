...
var errCarrierIneligible = errors.New("entry carrier is no longer eligible")

// guardedConnection prevents the consumer from extending an Entry admission
// past its authenticated validity and absolute attempt deadline.
