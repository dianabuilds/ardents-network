...
func TestBootstrapPinsInputsAndKeepsShellThin(t *testing.T) {
	...
	for _, relative := range []string{
		filepath.Join("internal", "preflight", "evidence_model.go"),
		filepath.Join("internal", "preflight", "bootstrap.go"),
		filepath.Join("internal", "preflight", "bootstrap_docker.go"),
		filepath.Join("internal", "preflight", "bootstrap_environment.go"),
	} {
