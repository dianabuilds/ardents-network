...
func (s failingTransferState) Complete(string, string, int64, string) (Record, error) {
	return Record{}, s.completeErr
}

func (s failingTransferState) Fail(string, string, string) (Record, error) {
