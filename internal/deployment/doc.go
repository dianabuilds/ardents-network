...
// Deployment Fence and Rejoin Transactions over consumer-owned adapters. It
// does not own host access, concrete runtime/network mutation, Authority or
// repository truth, rollout journals, or reachability qualification.
package deployment
