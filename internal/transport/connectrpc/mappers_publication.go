...
func toPublicationStatusSnapshot(in hostingapi.PublicationStatusSnapshot) *ardentsv1.PublicationStatusSnapshot {
...
func toHostedServiceSnapshot(in hostingapi.HostedServiceSnapshot) *ardentsv1.HostedServiceSnapshot {
...
func toHostedServiceSnapshots(items []hostingapi.HostedServiceSnapshot) []*ardentsv1.HostedServiceSnapshot {
...
func toHostedServiceStatusSnapshot(in hostingapi.HostedServiceStatusSnapshot) *ardentsv1.HostedServiceStatusSnapshot {
