...
// validAcknowledgement verifies the retained Introduction receipt before it
// enters the target-owned publication record. Its H3 historical bytes remain
// an explicit M9 retirement input, not a publication encoding or writer.
