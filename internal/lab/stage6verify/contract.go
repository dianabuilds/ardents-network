...
// Verdict is the only bounded output of Stage6Verifier.Verify.
type Verdict struct {
	Schema         string   `json:"schema"`
	CampaignSHA256 string   `json:"campaign_sha256"`
...
// Stage6Verifier owns strict structural admission and behavioral recomputation.
type Stage6Verifier struct{}
