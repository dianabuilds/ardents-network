...
func validFinalSpec() finalSpec {
	...
	spec := finalSpec{Schema: "ardents-h3-s5-final-spec-v1", RepositoryCommit: strings.Repeat("b", 40),
		...
		SupplyLock:       artifactCommitment{Path: "runtime/supply.lock.json", SHA256: hash, Bytes: 1},
		RuntimeCompose:   artifactCommitment{Path: "runtime/blocked-entry.compose.yaml", SHA256: hash, Bytes: 1},
		ProductReceipt: finalProductReceipt{SourceSHA256: hash,
			GoArchiveSHA256: "708effb774be8237570d0add163225abbdfaf4fca28b2611df167beba4feef89",
			GoRecipeSHA256:  hash, GoModuleSHA256: hash,
			RouteSHA256: hash, BridgeSHA256: hash,
			ServiceSHA256: hash, StreamSHA256: hash, PublishSHA256: hash, NetworkSHA256: hash, AdapterSHA256: hash},
		ToolReceipt: finalToolReceipt{BaseDigest: acceptedFinalImageHash, ToolLockSHA256: hash,
			SourceSHA256: hash, CarrierSHA256: hash},
