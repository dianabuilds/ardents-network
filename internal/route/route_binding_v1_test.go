...
func TestLegBindingV2CanonicalVectorAndReciprocalPeer(t *testing.T) {
	first := bindingFixture()
	raw, err := EncodeLegBinding(first)
	if err != nil {
		t.Fatal(err)
	}
	const want = ""
...
func TestLegBindingV2RejectsMalformedAndDowngradedBytes(t *testing.T) {
