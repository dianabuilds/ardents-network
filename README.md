...
- [Product vision and operating model](docs/product/vision.md)
- [Network functional map and journeys](docs/product/functional-map.md)
- [Domain language](CONTEXT.md)
- [Threat model](docs/security/threat-model.md)
- [Open and completed research](docs/research/questions.md)
- [Development documentation](docs/development/README.md)
- [Current Stage 8 target architecture](docs/development/stage-8-target-architecture.md)
- [Current package map](docs/development/package-map.md)
- [Architecture decisions](docs/adr/README.md)
- [Contributor workflow](CONTRIBUTING.md)

The historical H3 and stage records remain provenance, not a route to current
runtime or operational behavior. The development index explains when those
records are useful and points to their current owners.
