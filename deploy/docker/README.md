...
host. See `docs/operations/deployment-contract.md` for the security and lifecycle contract.
...
```powershell
docker compose -f deploy/docker/compose/docker-compose.production.yml config --quiet
```
