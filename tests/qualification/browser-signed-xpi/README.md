# Mozilla-signed Browser Entry XPI qualification

## Question

Did Mozilla return the exact Browser Entry XPI selected for the alpha,
...
```powershell
make qualification-browser-signed-xpi ARDENTS_BROWSER_SIGNED_XPI='C:/absolute/path/to/signed.xpi'
```
