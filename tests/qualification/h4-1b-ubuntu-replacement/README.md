# H4-1B Ubuntu replacement qualification

Run `make qualification-h4-1b` only on a clean, unprivileged Ubuntu Linux
...
target qualifies only the explicit H4-1B Ubuntu foreground paths. It is not
