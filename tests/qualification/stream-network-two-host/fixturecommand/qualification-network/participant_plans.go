...
func writeParticipantPlans(config fixtureConfig, result *generatedPlanIndex, networkID, authority, epochDigest string,
	...
	net32 := qualificationOwnerDocument{Mode: "net32-idle", Participants: []qualificationOwnerParticipant{reader.Participants[0]}}
	net32.Participants[0].Profile, net32.Participants[0].Condition, net32.Participants[0].Link = 1, 1, ""
