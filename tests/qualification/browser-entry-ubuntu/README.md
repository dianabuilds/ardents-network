# Ubuntu container enrollment-v4 Browser Entry qualification
...
```powershell
make qualification-browser-entry-ubuntu ARDENTS_BROWSER_SIGNED_XPI='C:/absolute/path/to/signed.xpi'
```
