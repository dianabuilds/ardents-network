# H4-1A Ubuntu Portable qualification

Run `make qualification-h4-1a` only on a clean, unprivileged Ubuntu Linux
...
is Ubuntu H4-1A profile evidence only; it is not a public artifact, participant
