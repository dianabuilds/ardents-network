...
func TestBundleInspectionReportExposesExactVerifiedControlInputs(t *testing.T) {
	...
	report := inspection.Report{
		...
		NetworkID:                   [32]byte{0xef}, NetworkEpoch: 11, NetworkDigest: [32]byte{0x31}, NetworkProfile: "ardents-interactive-route-v2",
	...
	want = strings.ReplaceAll(want, "\"network_profile\":\"ardents-interactive-route-v1\"", "\"network_profile\":\"ardents-interactive-route-v2\"")
