...
func synthesizedDecision() releasedecision.Decision {
	return releasedecision.Decision{
		...
		Path:               "ardents/windows-amd64/application",
		Length:             4096,
		Digest:             make([]byte, 32),
		...
		BuildIdentity:      "build-0001",
		DependencyIdentity: "deps-0001",
		SBOMIdentity:       "sbom-0001",
		AttestationPolicy:  "two-builder",
		Qualification:      "development",
		ProtocolPhase:      "overlap-supported",
...
// _ ensures the strings package stays imported for the test
// helpers that may need it.
