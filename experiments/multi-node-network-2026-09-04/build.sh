#!/bin/bash
# Disposable build script for the multi-node pilot. Cross-compiles the two
# maintained commands used by the experiment plus its test-driver for linux/amd64
